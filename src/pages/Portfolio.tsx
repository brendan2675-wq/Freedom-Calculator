                  ...
                  {(() => {
                    ...
                    return (
                      <div className="text-right space-y-1">
                        <div>
                          <label className="text-muted-foreground text-[10px] block">Rate</label>
                          <p className="text-sm font-bold text-foreground">{weightedRate.toFixed(2)}%</p>
                        </div>
                        <div>
                          <label className="text-muted-foreground text-[10px] block">Term</label>
                          <p className="text-sm font-bold text-foreground">{termYears}y{termMonths > 0 ? ` ${termMonths}m` : ''}</p>
                        </div>
                      </div>
                    );
                  })()}
